...
| **[`GoogleDrive/`](https://github.com/maryanneoliveira/VitualBox_ProjetoFinal/tree/main/GoogleDrive)** | Diretório contendo os arquivos individuais de especificação de cada máquina (Fichas Técnicas) e as orientações/links para download dos arquivos de exportação `.ova`. |
